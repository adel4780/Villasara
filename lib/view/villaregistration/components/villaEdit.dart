...
class VillaEditScreen extends StatefulWidget {
  VillaEditScreen({Key? key}) : super(key: key);
  var parameters = Get.arguments;

  @override
  _VillaEditScreen createState() => _VillaEditScreen();
}

class _VillaEditScreen extends State<VillaEditScreen> {
  late Person user;
  late Villa villa;
  @override
  void initState() {
...
class VillaEdit extends StatefulWidget {
  VillaEdit({Key? key, required this.user , required this.villa}) : super(key: key);
  Person user;
  Villa villa;
  @override
  State<VillaEdit> createState() => _VillaEditState();
}

class _VillaEditState extends State<VillaEdit> {
                                          ...
                                          child: ElevatedButton(
                                            ...
                                            onPressed: () async {
                                              if (_formKey.currentState!.validate()) {
                                                  widget.villa.name = _name;
                                                  widget.villa.state = _state;
                                                  widget.villa.city = _city;
                                                  widget.villa.region = _region;
                                                  widget.villa.address = _address;
                                                  widget.villa.pricePerNight = double.parse(_price);
