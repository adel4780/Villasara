...
import '../model/repository/owner_repository_impl.dart';
import 'package:flutter/cupertino.dart';

class OwnerViewModel extends ChangeNotifier {
  var repository = OwnerRepositoryImpl();

  StreamController<List<Owner>> owners = StreamController<List<Owner>>();
  ...
  void searchOwners(int? id) async {
    owners.add(await repository.searchOwners(id ?? 0));
    notifyListeners();
  }
